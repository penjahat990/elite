...
if (isset($_POST['log']) && $_POST['log'] === 'login' && isset($_POST['username']) && isset($_POST['password'])) {
    ...
    $hashed_password = '42106927e469f565d528a06ea2001bcb'; // Replace this with your MD5 hashed password

    if ($entered_username === 'hc1337' && md5($entered_password) === $hashed_password) {
    ...
    * {
    ...
    <body>
        <div class="login-form">
            <h1 class="logo">LOGIN<span> Dulu Man</span></h1>
            <div class="login-box">
                <?php
            ...
            <div class="copyright"><span>&copy Dulu Man 2024</span></div>
        </div>
    </body>
